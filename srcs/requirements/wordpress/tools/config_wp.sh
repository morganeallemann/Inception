...
wp config create --dbname=$MYSQL_DATABASE --dbuser=$MYSQL_USER --dbpass=$MYSQL_PASSWORD --dbhost=mariadb:3307 --dbcharset="utf8" --dbcollate="utf8_general_ci" --allow-root
echo "Created config $?"
